...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("skill-proposal", "Approve, reject, or inspect a drafted skill proposal",
               "Tools & Skills", aliases=("skill_proposal",),
               args_hint="<show|approve|reject> <proposal_id>",
               subcommands=("show", "approve", "reject"), gateway_only=True),

...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _register_command_menu(self) -> None:
        ...
        try:
            ...
            # Telegram Bot API allows up to 100 commands per scope. Keep the
            # platform maximum here so skill slash commands remain visible in
            # the native Telegram menu whenever possible.
